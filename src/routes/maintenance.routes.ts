...
router.get(
  ...
  maintenanceRequestsController.getMaintenanceRequests,
)
router.put(
  '/:id',
...
router.get(
  '/units/:unitId',
  validateQuery(PaginationSchema),
  maintenanceRequestsController.getMaintenanceRequestsOfUnit,
)
router.get(
  '/complexes/:complexId',
  validateQuery(PaginationSchema),
  maintenanceRequestsController.getMaintenanceRequestsOfComplex,
)

// Vendor-specific Routes
router.post(
  '/:id/vendor-response',
  maintenanceRequestsController.submitVendorResponse,
)
router.post(
  '/:id/complete',
  maintenanceRequestsController.completeMaintenanceRequest,
)
