...
//  * @param {string} staffId - The ID of the authenticated staff.
...
//   if (!lease || lease.staffId !== staffId) {
...
//     // later trigger other notifications immediately (e.g., staff confirmation)
...
//   Prisma.PaymentGetPayload<{ include: typeof include }>
// > | null> => {
