...
export const generateLeasePDF = async (
  ...
  doc
    .fontSize(8)
    .text(
      `Document generated by Smart Landlord Platform on ${today.toISOString()}`,
      { align: 'center' },
    )
...
export const generateRentCardPDF = async (
  ...
  const landlordName = lease.landlord?.user
    ? `${lease.landlord.firstName} ${lease.landlord.lastName}`
    : 'N/A'
  ...
  doc
    .fontSize(8)
    .text(
      `Document generated by Smart Landlord Platform on ${new Date().toISOString()}`,
      { align: 'center' },
    )
...
export const generateReceiptPDF = async (
  ...
  doc
    .fontSize(10)
    .text(`Transaction Ref: ${payment.transactionRef || 'N/A'}`, {
      align: 'center',
    })
  doc.moveDown(2)
  ...
  doc
    .fontSize(8)
    .text(`Document generated by Smart Landlord Platform`, { align: 'center' })
